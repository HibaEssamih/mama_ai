      ...
      <div className="flex items-center gap-4 flex-1 min-w-[300px]">
        ...
        <button
          ...
          className={`px-4 py-2 rounded-lg text-sm font-bold flex items-center gap-2 transition-all cursor-pointer ${
            showHighRiskOnly ? 'bg-orange-500 text-white shadow-lg shadow-orange-200' : 'bg-slate-100 text-slate-600 hover:bg-slate-200'
          }`}
        >
        ...
        {onRefresh && (
          ...
          >
            <span className={`material-symbols-outlined text-[22px] ${refreshing ? "animate-spin" : ""}`}>
              refresh
            </span>
          </button>
        )}
