...
export default function DashboardHeader({ stats }: DashboardHeaderProps) {
  ...
  const handleNotificationClick = (notificationId: string) => {
    ...
    // Don't close dialog when clicking notification
  };
  ...
  const handleNotificationAction = (notificationId: string, action: string) => {
    ...
    if (notification?.type === "critical" || notification?.type === "warning") {
      // Extract patient info from message if possible, or go to dashboard
  ...
  return (
    ...
    >
      {/* Search - Desktop */}
      <div
        className={`flex-1 max-w-xl ${showMobileSearch ? "hidden sm:block" : "hidden md:block"}`}
      >
                                ...
                                <div className="flex items-start justify-between gap-2 mb-1">
                                  ...
                                  <div className="flex items-center gap-1">
                                    ...
                                    <button
                                      ...
                                      className="opacity-0 group-hover:opacity-100 transition-opacity text-slate-400 hover:text-slate-600 p-1 rounded focus:outline-none focus:ring-2 focus:ring-sky-500"
                                  ...
                                  {(notification.type === "critical" ||
                                    ...
                                    <div className="flex gap-2">
                                      <button
                                        ...
                                        className="text-xs font-medium text-sky-600 hover:text-sky-700 px-2 py-1 rounded hover:bg-sky-50 transition-colors focus:outline-none focus:ring-2 focus:ring-sky-500"
                                      >
                                        View Patient
                                      </button>
                                      <button
                                        ...
                                        className="text-xs font-medium text-slate-600 hover:text-slate-700 px-2 py-1 rounded hover:bg-slate-100 transition-colors focus:outline-none focus:ring-2 focus:ring-sky-500"
                                      >
                                        Acknowledge
                                      </button>
                                    </div>
