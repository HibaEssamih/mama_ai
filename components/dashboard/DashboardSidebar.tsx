  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Emergency Protocols */}
        <div className="px-2 py-3 rounded-lg bg-red-50 border border-red-200">
          ...
          <Link
            ...
            className="flex items-center gap-2 px-2 py-1.5 text-xs text-red-700 hover:text-red-900 hover:bg-red-100 rounded transition-colors"
          >
