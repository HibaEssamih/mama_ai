...
export default function TestimonialsSection() {
  return (
    <section id="testimonials" className="py-20 bg-surface-dark border-y border-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <header className="flex flex-col md:flex-row justify-between items-end mb-12">
          ...
          <span className="material-icons-round text-6xl text-primary/10 hidden md:block transform translate-y-4" aria-hidden="true">format_quote</span>
        </header>
