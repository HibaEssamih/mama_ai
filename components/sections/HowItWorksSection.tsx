    ...
    <section id="how-it-works" className="py-20 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          ...
          <div className="hidden md:block absolute top-12 left-[10%] right-[10%] h-0.5 bg-gray-200 dark:bg-gray-700 -z-10" aria-hidden="true"></div>
          {/* Progress Line Gradient overlay */}
          <div className="hidden md:block absolute top-12 left-[10%] w-3/4 h-0.5 bg-gradient-to-r from-primary/20 via-primary to-primary/20 -z-10 opacity-50" aria-hidden="true"></div>
          ...
          <ol className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <li className="flex flex-col items-center text-center group">
              <div className="w-24 h-24 bg-card-dark border border-gray-700 rounded-full flex items-center justify-center mb-6 shadow-lg shadow-primary/5 group-hover:border-primary/50 transition-colors duration-300 relative">
                ...
                <span className="material-icons-round text-4xl text-primary" aria-hidden="true">mic</span>
              </div>
            ...
            <li className="flex flex-col items-center text-center group">
              <div className="w-24 h-24 bg-card-dark border border-gray-700 rounded-full flex items-center justify-center mb-6 shadow-lg shadow-primary/5 group-hover:border-primary/50 transition-colors duration-300 relative">
                ...
                <span className="material-icons-round text-4xl text-primary" aria-hidden="true">psychology</span>
              </div>
            ...
            <li className="flex flex-col items-center text-center group">
              <div className="w-24 h-24 bg-card-dark border border-gray-700 rounded-full flex items-center justify-center mb-6 shadow-lg shadow-primary/5 group-hover:border-primary/50 transition-colors duration-300 relative">
                ...
                <span className="material-icons-round text-4xl text-primary" aria-hidden="true">notifications_active</span>
              </div>
            ...
            <li className="flex flex-col items-center text-center group">
              <div className="w-24 h-24 bg-card-dark border border-gray-700 rounded-full flex items-center justify-center mb-6 shadow-lg shadow-primary/5 group-hover:border-primary/50 transition-colors duration-300 relative">
                ...
                <span className="material-icons-round text-4xl text-primary" aria-hidden="true">family_restroom</span>
              </div>
