export default function ProblemSection() {
  return (
    <section id="problem" className="py-12 sm:py-16 md:py-20 bg-white dark:bg-[#132326] relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
          {/* Card 1 */}
          <article className="group bg-background-light dark:bg-background-dark p-6 sm:p-8 rounded-2xl border border-gray-100 dark:border-white/5 hover:border-primary/30 transition-all duration-300 hover:shadow-xl hover:shadow-primary/5">
            <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-primary/10 flex items-center justify-center text-primary mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300" aria-hidden="true">
          ...
          {/* Card 3 */}
          <article className="group bg-background-light dark:bg-background-dark p-6 sm:p-8 rounded-2xl border border-gray-100 dark:border-white/5 hover:border-primary/30 transition-all duration-300 hover:shadow-xl hover:shadow-primary/5 sm:col-span-2 md:col-span-1">
            <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-primary/10 flex items-center justify-center text-primary mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300" aria-hidden="true">
