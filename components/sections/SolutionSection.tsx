export default function SolutionSection() {
  return (
    <section id="solution" className="py-16 sm:py-20 md:py-24 bg-background-light dark:bg-background-dark relative overflow-hidden">
      {/* Abstract gradient blob */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] sm:w-[800px] sm:h-[800px] bg-primary/5 rounded-full blur-3xl pointer-events-none" aria-hidden="true"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {/* Feature 1 */}
          <article className="bg-white dark:bg-card-dark p-5 sm:p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-white/5 hover:shadow-md transition-shadow">
            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg bg-teal-50 dark:bg-teal-900/20 text-teal-600 dark:text-teal-400 flex items-center justify-center mb-3 sm:mb-4" aria-hidden="true">
              <span className="material-icons-round text-xl sm:text-2xl">record_voice_over</span>
            </div>
            <h3 className="text-base sm:text-lg font-bold text-slate-900 dark:text-white mb-2">Voice Check-ins</h3>
          ...
          {/* Feature 2 */}
          <article className="bg-white dark:bg-card-dark p-5 sm:p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-white/5 hover:shadow-md transition-shadow">
            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 flex items-center justify-center mb-3 sm:mb-4" aria-hidden="true">
              <span className="material-icons-round text-xl sm:text-2xl">analytics</span>
            </div>
            <h3 className="text-base sm:text-lg font-bold text-slate-900 dark:text-white mb-2">Risk Detection</h3>
            <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400">
          ...
          {/* Feature 3 */}
          <article className="bg-white dark:bg-card-dark p-5 sm:p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-white/5 hover:shadow-md transition-shadow">
            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg bg-indigo-50 dark:bg-indigo-900/20 text-indigo-600 dark:text-indigo-400 flex items-center justify-center mb-3 sm:mb-4" aria-hidden="true">
              <span className="material-icons-round text-xl sm:text-2xl">dashboard</span>
            </div>
            <h3 className="text-base sm:text-lg font-bold text-slate-900 dark:text-white mb-2">Doctor Dashboard</h3>
            <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400">
          ...
          {/* Feature 4 */}
          <article className="bg-white dark:bg-card-dark p-5 sm:p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-white/5 hover:shadow-md transition-shadow">
            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg bg-pink-50 dark:bg-pink-900/20 text-pink-500 dark:text-pink-400 flex items-center justify-center mb-3 sm:mb-4" aria-hidden="true">
              <span className="material-icons-round text-xl sm:text-2xl">family_restroom</span>
            </div>
            <h3 className="text-base sm:text-lg font-bold text-slate-900 dark:text-white mb-2">Family Engagement</h3>
            <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400">
